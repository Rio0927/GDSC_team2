...
class CourseSchedule(models.Model):
    ...
    course_instance = models.ForeignKey(CourseInstance, on_delete=models.CASCADE, related_name='schedules')  # 科目のインスタンスへの参照
    day_of_week = models.CharField(max_length=5, choices=DAY_OF_WEEK_CHOICES)  # 曜日
    period = models.IntegerField()  # 時間帯
    classroom = models.CharField(max_length=50, null=True, blank=True) #教室
...
class Timetable(models.Model):
    ...
    course_instance = models.ForeignKey(CourseInstance, on_delete=models.CASCADE)  # 科目のインスタンスへの参照
